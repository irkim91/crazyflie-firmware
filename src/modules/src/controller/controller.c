...
static ControllerFcns controllerFunctions[] = {
  ...
  {.init = controllerFuzzyInit, .test = controllerFuzzyTest, .update = controllerFuzzy, .name = "Fuzzy"},
...
void controllerInit(ControllerType controller) {
  ...
  #elif defined(CONFIG_CONTROLLER_FUZZY)
    #define CONTROLLER ControllerTypeFuzzy
